...
# __C.ASSETS_PATH = '/home/tnguyen/coding/imgSeg/NVDIASemanticSeg/assets'
__C.ASSETS_PATH = '/home/tnguyen/coding/imgSeg/NVDIASemanticSeg/assets_smc'
...
def assert_and_infer_cfg(args, make_immutable=True, train_mode=True):
    ...
    if args.dump_assets and args.dataset in ['cityscapes', 'smc']:
